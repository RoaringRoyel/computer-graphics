...
def draw_spaceship(centerX=0, centerY=-365):
    ...
    glColor3f(1, 0.5, 0)
    # Top edge
    midpoint_line(centerX - 10, centerY + 80, centerX + 10, centerY + 80)
    # Right edge
    midpoint_line(centerX + 10, centerY + 80, centerX + 10, centerY - 20)
    # Bottom edge
    midpoint_line(centerX + 10, centerY - 20, centerX - 10, centerY - 20)
    # Left edge
    midpoint_line(centerX - 10, centerY - 20, centerX - 10, centerY + 80)
    
    # Rocket nose (triangle)
    glColor3f(1, 0, 1)
    # Line from top vertex to bottom-left vertex
    midpoint_line(centerX, centerY + 100, centerX - 10, centerY + 80)
    # Line from bottom-left vertex to bottom-right vertex
    midpoint_line(centerX - 10, centerY + 80, centerX + 10, centerY + 80)
    # Line from bottom-right vertex to top vertex
    midpoint_line(centerX + 10, centerY + 80, centerX, centerY + 100)
    
    # Line from top vertex to bottom-left vertex
    midpoint_line(centerX - 10, centerY - 20, centerX - 30, centerY - 40)
    # Line from bottom-left vertex to bottom-right vertex
    midpoint_line(centerX - 30, centerY - 40, centerX - 10, centerY - 40)
    # Line from bottom-right vertex back to the top vertex
    midpoint_line(centerX - 10, centerY - 40, centerX - 10, centerY - 20)

    glColor3f(1, 0.5, 1)

    # Line from top vertex to bottom-right vertex
    midpoint_line(centerX + 10, centerY - 20, centerX + 30, centerY - 40)
    # Line from bottom-right vertex to bottom-left vertex
    midpoint_line(centerX + 30, centerY - 40, centerX + 10, centerY - 40)
    # Line from bottom-left vertex back to the top vertex
    midpoint_line(centerX + 10, centerY - 40, centerX + 10, centerY - 20)
